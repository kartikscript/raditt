...
const SignIn = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-4">
      ...
      <UserAuthForm/>
      <p className="text-sm text-gray-600 font-medium">New to Raditt? <Link href='/sign-up' className="text-violet-300 hover:text-violet-400 focus:text-violet-400 underline underline-offset-2">Click here to sign up</Link></p>      
    </div>
  )
}
